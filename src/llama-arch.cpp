...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_RES_SCALE_HS_MLP,                       "blk.%d.res_scale_hs.mlp" },
    { LLM_TENSOR_RES_SCALE_RES_MLP,                      "blk.%d.res_scale_res.mlp" },
    { LLM_TENSOR_RES_SCALE_HS_FINAL,                     "res_scale_hs" },
    { LLM_TENSOR_RES_SCALE_RES_FINAL,                    "res_scale_res" },
    { LLM_TENSOR_ZAYA_INPUT_SCALE,                       "input_hidden_states_scale" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_ZAYA_INPUT_SCALE,           {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL}},
