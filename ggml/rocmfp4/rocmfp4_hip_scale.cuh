...
// Precomputed lookup table for UE4M3 → float32 conversion (127 valid entries, 0x00..0x7e).
// Index by the scale byte directly. 0x7f returns 0.0f.
static __device__ __constant__ const float rocmfpx_scale_f32[128] = {
    0.0f/1024.0f,    1.0f/1024.0f,    2.0f/1024.0f,    3.0f/1024.0f,
    4.0f/1024.0f,    5.0f/1024.0f,    6.0f/1024.0f,    7.0f/1024.0f,
    (8.0f+0.0f)*0.0009765625f, (8.0f+1.0f)*0.0009765625f, (8.0f+2.0f)*0.0009765625f, (8.0f+3.0f)*0.0009765625f,
    (8.0f+4.0f)*0.0009765625f, (8.0f+5.0f)*0.0009765625f, (8.0f+6.0f)*0.0009765625f, (8.0f+7.0f)*0.0009765625f,
    (8.0f+0.0f)*0.0019531250f, (8.0f+1.0f)*0.0019531250f, (8.0f+2.0f)*0.0019531250f, (8.0f+3.0f)*0.0019531250f,
    (8.0f+4.0f)*0.0019531250f, (8.0f+5.0f)*0.0019531250f, (8.0f+6.0f)*0.0019531250f, (8.0f+7.0f)*0.0019531250f,
    (8.0f+0.0f)*0.0039062500f, (8.0f+1.0f)*0.0039062500f, (8.0f+2.0f)*0.0039062500f, (8.0f+3.0f)*0.0039062500f,
    (8.0f+4.0f)*0.0039062500f, (8.0f+5.0f)*0.0039062500f, (8.0f+6.0f)*0.0039062500f, (8.0f+7.0f)*0.0039062500f,
    (8.0f+0.0f)*0.0078125000f, (8.0f+1.0f)*0.0078125000f, (8.0f+2.0f)*0.0078125000f, (8.0f+3.0f)*0.0078125000f,
    (8.0f+4.0f)*0.0078125000f, (8.0f+5.0f)*0.0078125000f, (8.0f+6.0f)*0.0078125000f, (8.0f+7.0f)*0.0078125000f,
    (8.0f+0.0f)*0.0156250000f, (8.0f+1.0f)*0.0156250000f, (8.0f+2.0f)*0.0156250000f, (8.0f+3.0f)*0.0156250000f,
    (8.0f+4.0f)*0.0156250000f, (8.0f+5.0f)*0.0156250000f, (8.0f+6.0f)*0.0156250000f, (8.0f+7.0f)*0.0156250000f,
    (8.0f+0.0f)*0.0312500000f, (8.0f+1.0f)*0.0312500000f, (8.0f+2.0f)*0.0312500000f, (8.0f+3.0f)*0.0312500000f,
    (8.0f+4.0f)*0.0312500000f, (8.0f+5.0f)*0.0312500000f, (8.0f+6.0f)*0.0312500000f, (8.0f+7.0f)*0.0312500000f,
    (8.0f+0.0f)*0.0625000000f, (8.0f+1.0f)*0.0625000000f, (8.0f+2.0f)*0.0625000000f, (8.0f+3.0f)*0.0625000000f,
    (8.0f+4.0f)*0.0625000000f, (8.0f+5.0f)*0.0625000000f, (8.0f+6.0f)*0.0625000000f, (8.0f+7.0f)*0.0625000000f,
    (8.0f+0.0f)*0.1250000000f, (8.0f+1.0f)*0.1250000000f, (8.0f+2.0f)*0.1250000000f, (8.0f+3.0f)*0.1250000000f,
    (8.0f+4.0f)*0.1250000000f, (8.0f+5.0f)*0.1250000000f, (8.0f+6.0f)*0.1250000000f, (8.0f+7.0f)*0.1250000000f,
    (8.0f+0.0f)*0.2500000000f, (8.0f+1.0f)*0.2500000000f, (8.0f+2.0f)*0.2500000000f, (8.0f+3.0f)*0.2500000000f,
    (8.0f+4.0f)*0.2500000000f, (8.0f+5.0f)*0.2500000000f, (8.0f+6.0f)*0.2500000000f, (8.0f+7.0f)*0.2500000000f,
    (8.0f+0.0f)*0.5000000000f, (8.0f+1.0f)*0.5000000000f, (8.0f+2.0f)*0.5000000000f, (8.0f+3.0f)*0.5000000000f,
    (8.0f+4.0f)*0.5000000000f, (8.0f+5.0f)*0.5000000000f, (8.0f+6.0f)*0.5000000000f, (8.0f+7.0f)*0.5000000000f,
    (8.0f+0.0f)*1.0000000000f, (8.0f+1.0f)*1.0000000000f, (8.0f+2.0f)*1.0000000000f, (8.0f+3.0f)*1.0000000000f,
    (8.0f+4.0f)*1.0000000000f, (8.0f+5.0f)*1.0000000000f, (8.0f+6.0f)*1.0000000000f, (8.0f+7.0f)*1.0000000000f,
    (8.0f+0.0f)*2.0000000000f, (8.0f+1.0f)*2.0000000000f, (8.0f+2.0f)*2.0000000000f, (8.0f+3.0f)*2.0000000000f,
    (8.0f+4.0f)*2.0000000000f, (8.0f+5.0f)*2.0000000000f, (8.0f+6.0f)*2.0000000000f, (8.0f+7.0f)*2.0000000000f,
    (8.0f+0.0f)*4.0000000000f, (8.0f+1.0f)*4.0000000000f, (8.0f+2.0f)*4.0000000000f, (8.0f+3.0f)*4.0000000000f,
    (8.0f+4.0f)*4.0000000000f, (8.0f+5.0f)*4.0000000000f, (8.0f+6.0f)*4.0000000000f, (8.0f+7.0f)*4.0000000000f,
    (8.0f+0.0f)*8.0000000000f, (8.0f+1.0f)*8.0000000000f, (8.0f+2.0f)*8.0000000000f, (8.0f+3.0f)*8.0000000000f,
    (8.0f+4.0f)*8.0000000000f, (8.0f+5.0f)*8.0000000000f, (8.0f+6.0f)*8.0000000000f, (8.0f+7.0f)*8.0000000000f,
    (8.0f+0.0f)*16.000000000f, (8.0f+1.0f)*16.000000000f, (8.0f+2.0f)*16.000000000f, (8.0f+3.0f)*16.000000000f,
    (8.0f+4.0f)*16.000000000f, (8.0f+5.0f)*16.000000000f, 0.0f,
};

static __device__ __forceinline__ float rocmfpx_ue4m3_to_fp32_finite(uint8_t x) {
    return x <= 0x7e ? rocmfpx_scale_f32[x] : 0.0f;
}
